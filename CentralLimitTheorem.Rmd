...
hist(mns_10, main="Mean Exponential Distribution", 
     xlab="Result", 
     col="lightgreen", 
     las=1, 
     breaks=10,      
...
curve(dnorm(x, mean=mean(mns_10), sd=sd(mns_10)), add=TRUE, lwd=3, lty=5)

hist(mns_1000, main="Mean Exponential Distribution", 
     xlab="Result", 
     col="lightgreen", 
     las=1, 
     breaks=200, 
...
abline(v=theoretical_mean, col="red", lwd=3)
curve(dnorm(x, mean=mean(mns_1000), sd=sd(mns_1000)), add=TRUE, lwd=3, lty=5)
```